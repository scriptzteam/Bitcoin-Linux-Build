...
apt update
apt install git build-essential autoconf bsdmainutils pkg-config libtool libboost-dev libevent-dev gcc-11 g++-11 g++ autotools-dev libicu-dev libbz2-dev libboost-all-dev
